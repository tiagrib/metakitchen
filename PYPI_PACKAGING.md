# MetaKitchen PyPI Distribution

This directory contains the files needed to package and distribute MetaKitchen to PyPI.
...
```bash
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ --no-cache-dir --force-reinstall --no-deps metakitchen
```